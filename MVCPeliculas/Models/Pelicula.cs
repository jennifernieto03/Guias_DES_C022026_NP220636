...
public class Pelicula
{
    ...
    [StringLength(15)]
    [Required]
    [RegularExpression(@"^[A-Z]+[a-zA-Z""'\s-]*$", ErrorMessage = "El nombre del director debe comenzar con mayúscula y solo puede contener letras, espacios, comillas y guiones.")]
